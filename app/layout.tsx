...
export const metadata: Metadata = {
  ...
  description:
    "Local-first context bus for Claude Code, Cursor, VS Code, Windsurf, Zed, Cline, and 15 more coding LLMs. No vendor lock-in. No cloud round-trip. The daemon runs on 127.0.0.1.",
  metadataBase: new URL("https://wevex.vercel.app"),
  openGraph: {
    title: "Wevex",
    description:
      "Local-first context bus for Claude Code, Cursor, VS Code, Windsurf, Zed, Cline, and 15 more coding LLMs. Apache 2.0, runs on 127.0.0.1.",
    type: "website",
